...
33) More and more KB highlight images are, in addition to the bibliographic metadata mentioned at 28), also provided with **structured, machine-readable data**. This will associate these images with Wikidata. Because Wikidata is part of the [Linked Open Data Cloud](https://lod-cloud.net/), the KB images are connected to other data sources outside the KB. This ultimately makes our highlights easier to find, visible and reusable.

  <kbd><img src="images/image-p4-020.png" width="100%"/></kbd><br/><sub>*aaaa. Screenshot Wikipedia d.d. 02-04-2021*</sub>
