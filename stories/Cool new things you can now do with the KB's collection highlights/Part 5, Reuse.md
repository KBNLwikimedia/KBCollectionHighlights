 ...
 *3) An HTML facebook from a Wikidata SPARQL query using an embedded iframe* - fdsf dsf 
 
 <kbd><img src="images/image-p5-018.png" height="300"/></kbd><kbd><img src="images/image-p5-019.png" height="300"/></kbd>
 <br/><sub>*aaaaaaaa. 
	
	 HTML portrait galleries of contributors to the Album amicorum Jacob Heyblocq via 1) the [Wikimedia Commons API](https://kbnlwikimedia.github.io/Alba-Amicorum/alba/AA-Jacob-Heyblocq/reuse/bijdragersAAJH-smoelenboek-CommmonsAPI.html), 2) and 3).. 
	
	
	
	Screenshots d.d. 14-05-2021*</sub>
...
46) alternative approaches for generating image galleries - 3 ways <br/>
47) <br/>
48) <br/>
49) <br/>
50) <br/>
