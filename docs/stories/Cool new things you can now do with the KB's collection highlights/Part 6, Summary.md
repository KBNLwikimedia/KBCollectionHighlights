...
42) Readily available bulk image download tools for obtaining [hires image URLs](https://wikilovesdownloads.toolforge.org/) and/or the [hires images themselves](https://commons.wikimedia.org/wiki/Commons:Imker_(batch_download)) from a specific KB highlight category on Wikimedia Commons.<br/>
